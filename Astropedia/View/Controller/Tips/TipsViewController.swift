...
class TipsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        applyBlurEffect(to: tipsView, blurStyle: .regular, blurAlpha: 1, withCornerRadius: 20)
        applyBlurEffect(to: tips2View, blurStyle: .regular, blurAlpha: 1, withCornerRadius: 20)
        applyBlurEffect(to: tips3View, blurStyle: .regular, blurAlpha: 1, withCornerRadius: 20)
    }
}
